...
<section class="pt-[90px] pb-[100px] bg-[#FF0000]">
	<div class="max-w-[1100px] mx-auto">
		...
		<h2 class="font-black text-white text-center my-8 text-[90px]"><?php echo get_field('titulo_2') ?></h2>
		<p class="text-white text-justify text-[30px] leading-[41px]">
			<?php echo strip_tags(get_field('texto_2')) ?>
		</p>

		<h2 class="font-black text-white text-center my-8 text-[90px]"><?php echo get_field('titulo_3') ?></h2>
		<p class="text-white text-justify text-[30px] leading-[41px]">
