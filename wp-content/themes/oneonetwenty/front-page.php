...
<section class="ky-banners">
	<div class="grid md:grid-cols-2">
		<a class="overflow-clip md:rounded-br-[20px] md:rounded-bl-[20px]" href="<?php echo $banners_fields['enlace_banner_1'] ?>">
			<img class="md:h-[280px] hover:scale-[105%] transition-all h-auto w-full bg-gray-300 object-cover md:rounded-br-[20px] md:rounded-bl-[20px]" src="<?php echo $banners_fields['imagen_banner_1']['url'] ?>" alt="">
		</a>
		<a class="overflow-clip md:rounded-br-[20px] md:rounded-bl-[20px]" href="<?php echo $banners_fields['enlace_banner_2'] ?>">
			<img class="md:h-[280px] hover:scale-[105%] transition-all h-auto w-full bg-gray-300 object-cover md:rounded-br-[20px] md:rounded-bl-[20px]" src="<?php echo $banners_fields['imagen_banner_2']['url'] ?>" alt="">
		</a>
	</div>
</section>

<!-- call_to_action? -->
<section class="py-[60px] group">
...
<section class="group ky-historia bg-[#FF0000] rounded-tr-[20px] pt-[40px] rounded-[20px]">
	...
	<div class="bg-[#111] rounded-[20px] p-4 mt-[90px]">
		<div class="tcp-container">
			<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/6y1YWIGoyj3OPeuknSmjfl?utm_source=generator&theme=0" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
		</div>
	</div>
</section>
